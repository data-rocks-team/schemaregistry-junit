...
public class TestScenarioStringJson implements TestScenario<String, TestScenarioStringJson.User> {
    ...
    private static final String SCHEMA = "{" +
            ...
            "\"properties\":{" +
            "\"firstName\":{\"oneOf\":[{\"type\":\"null\",\"title\":\"Not included\"},{\"type\":\"string\"}]}," +
    ...
    public TestScenarioStringJson(String kafkaBootstrapServer,
        ...
        producerProperties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, KafkaJsonSchemaSerializer.class);
        ...
        consumerProperties.put(ConsumerConfig.GROUP_ID_CONFIG, TestScenarioStringJson.class.getCanonicalName());
