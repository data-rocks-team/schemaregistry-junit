...
public class TestScenarioStringProtobuf implements TestScenario<String, Myrecord.MyRecord> {
    ...
    public TestScenarioStringProtobuf(String kafkaBootstrapServer,
        ...
        consumerProperties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaProtobufDeserializer.class);
        consumerProperties.put(ConsumerConfig.GROUP_ID_CONFIG, TestScenarioStringProtobuf.class.getCanonicalName());
    ...
    public Optional<Schema> valueSchema() {
        return Optional.of(new Schema(topic() + "-value", 1, -1, "PROTOBUF",
