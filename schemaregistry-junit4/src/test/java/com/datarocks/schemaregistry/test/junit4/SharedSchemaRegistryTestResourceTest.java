...
public class SharedSchemaRegistryTestResourceTest {
  ...
  private final TestScenario<String, Object> avroScenario = new TestScenarioStringAvro(
      kafka.getKafkaConnectString(), schemaRegistry.schemaRegistryUrl(),
      schemaRegistry.schemaRegistryTestUtils().schemaRegistryClient());
  private final TestScenario<String, TestScenarioStringJson.User> jsonScenario =
      new TestScenarioStringJson(kafka.getKafkaConnectString(), schemaRegistry.schemaRegistryUrl(),
          schemaRegistry.schemaRegistryTestUtils().schemaRegistryClient());
  private final TestScenario<String, Myrecord.MyRecord> protobufScenario =
      new TestScenarioStringProtobuf(kafka.getKafkaConnectString(),
