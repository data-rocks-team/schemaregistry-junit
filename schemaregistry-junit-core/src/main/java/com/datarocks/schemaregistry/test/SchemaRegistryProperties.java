 ...
 * </ul>
 * Every default value can be overridden by using
 * {@link SchemaRegistryProperties#addProperty(String, Object)}. Only
 * exception is {@link SchemaRegistryConfig#KAFKASTORE_BOOTSTRAP_SERVERS_CONFIG} which can be
 * overridden also via {@link SchemaRegistryProperties#addBootstrapServersSupplier(Supplier)}.
 * The {@link Supplier} will only be invoked upon constructing {@link SchemaRegistryConfig}.
 */
class SchemaRegistryProperties {
  ...
  static {
    ...
    DEFAULT_PROPERTIES.put(SchemaRegistryConfig.LISTENERS_CONFIG,
        singleListenerString(DEFAULT_PORT));
  ...
  /**
   * Construct an instance of {@link SchemaRegistryProperties} by using the provided
   * {@link Properties} as baseline.
   *
   ...
   * @return a {@link String} that can be used to connect to service running on {@code localhost
   * :[port]}.
   */
  ...
  /**
   * Provide a way to define {@link SchemaRegistryConfig#KAFKASTORE_BOOTSTRAP_SERVERS_CONFIG}
   * postponing the actual invocation of the {@link Supplier} till the last moment before
   * constructing {@link SchemaRegistryConfig}. This function can be used as an alternative to
   * {@link #addProperty(String, Object)} when the {@link String} to connect to Kafka cannot be
   * provided immediately.
   *
   * @param bootstrapServers {@link Supplier} of {@link String}to provide a {@link String} to
   *                                         connect to Kafka.
   */
   ...
   * {@link io.confluent.kafka.schemaregistry.rest.SchemaRegistryRestApplication}.
   *
   * @return an instance of {@link SchemaRegistryConfig} which can be used to configure a
  ...
  /**
   * URL to connect to the SchemaRegistry instantiated by the {@link SchemaRegistryConfig} created
   * by this instance.
   *
