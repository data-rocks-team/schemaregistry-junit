...
/**
 * {@link SchemaRegistryRestApplication} wrapper with dsl to configure any property supported by the
 * current version of Confluent SchemaRegistry.
...
public class SchemaRegistryTestResource<T extends SchemaRegistryTestResource> {
    ...
    /**
     * Set a supplier to delay the provision of the address to establish a connection to the Kafka cluster.
    ...
    /**
     * Helper to allow overriding SchemaRegistry properties. Can only be called prior to the service
     * being started.
    ...
    /**
     * Closes the internal server. Failing to call this at the end of your tests will likely result
     * in leaking instances.
     ...
     * @return Connect string to use for {@link io.confluent.kafka.schemaregistry.client.SchemaRegistryClient}.
     */
    ...
    /**
     * {@link SchemaRegistryTestUtils} is an helper class for interacting with the running SchemaRegistry.
     * @return Instance of {@link SchemaRegistryTestUtils} configured to operate with the running SchemaRegistry.
     */
